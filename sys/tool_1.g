M308 S2 P"0.temp1" Y"pt1000"		; Thermistor for toolboard T1 extruder heater
M950 H2 C"0.out1" T2										; Heater for extruder out toolboad T1
M143 H2 S300												; Set maximum temperature for hotend to 300C

M307 H1 A482.6 C232.8 D5.5 V23.9 B0 ;Auto tune results


M950 F2 C"0.out4"											; Define Hotend Fan on out1
...
M563 P1 S"Tool 1"  H2 									; Px = Tool number, Dx = Drive Number (start at 0, after movement drives), Hx = Heater Number, Fx = Fan number print cooling fan
